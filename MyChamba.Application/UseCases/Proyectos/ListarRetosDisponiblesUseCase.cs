...
public interface IListarProyectosPorEmpresaUseCase
{
...
/// </summary>
public class ListarRetosDisponiblesUseCase(IProyectoRepository _proyectoRepository, IUnitOfWork _unitOfWork)
    : IListarProyectosPorEmpresaUseCase
{
    /// <summary>
