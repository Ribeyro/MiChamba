using MyChamba.Data.Interface;              // Para el repositorio especializado de proyectos
using MyChamba.Data.UnitofWork;            // Para el acceso transaccional a los repositorios
using MyChamba.DTOs.Proyecto;              // Para los DTOs de entrada y salida
using MyChamba.Models;                     // Para las entidades de base de datos
using MyChamba.Services.Interfaces;        // Para la interfaz del servicio
